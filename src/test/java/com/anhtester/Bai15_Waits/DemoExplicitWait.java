...
public class DemoExplicitWait extends BaseTest {
   ...
   public void testExplicitWait(){
      ...
      ActionKeyword.setText(driver, By.id("ipassword"), "123456");
...
//      driver.findElement(By.xpath("//button[@data-style='expand-right']")).click();
      ...
      ActionKeyword.clickElement(driver, By.xpath("//button[@data-style='expand-right']"), 3);
...
//      wait2.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//span[normalize-space()='Home']")));
      ...
      boolean isElementPresent = ActionKeyword.isElementPresent(driver, By.xpath("//span[normalize-space()='Home']"), 3);
